...
dependency "argocd_certificate" {
  config_path = "../argocd_certificate"
...
# generate "argocd-ingress-providers" {
#   path      = "providers.tf"
...
inputs = {
  ...
  certificate_arn    = dependency.argocd_certificate.outputs.certificate_arn
  ...
  url                = local.common_vars.argocd_domain_name
}